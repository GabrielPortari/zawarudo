...
public class Operacoes {
    ...
    public void apresentaVencedor(int pontoJogador, String nomeJogador, int pontoNpc, String nomeNpc){
        System.out.println("Apresentador: Fim das nossas perguntas amigos!!!");
        System.out.println("Apresentador: Terminamos com o placar assim: ");
        System.out.println(nomeJogador + ": " + pontoJogador + " pontos !");
        System.out.println(nomeNpc + ": " + pontoNpc + " pontos !");
        if(pontoJogador > pontoNpc){
            System.out.println("Apresentador: E O NOSSO VENCEDOR FOI " + nomeJogador + "!!! PARABENS !!");
        }else if(pontoNpc > pontoJogador){
            System.out.println("Apresentador: E O NOSSO VENCEDOR FOI " + nomeNpc + "!!! PARABENS !!");
        }else{
            System.out.println("Apresentador: NINGUEM GANHOU, FOI UM EMPATE !!");
        }
